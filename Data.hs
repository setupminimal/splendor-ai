...
data Edit = TakeTwo Gem
  ...
  | Quit
  | Many [Edit]
  | Magic [Gem] Int [Int] GemBag -- Gems, Score, and Cards-removed-from-table
  | Reserve Bool Int
  | Win
...
data Gem = Diamond | Sapphire | Emerald | Ruby | Onyx | Joker deriving (Eq, Show, Enum, Bounded, Ord, Read)
...
fromNum' 14 = Card 0 Sapphire (GemBag 1 0 0 0 2 0) 14
fromNum' 74 = Card 0 Sapphire (GemBag 0 1 3 1 0 0) 74
fromNum' 34 = Card 0 Diamond (GemBag 0 3 0 0 0 0) 34
fromNum' 17 = Card 0 Diamond (GemBag 3 1 0 0 1 0) 17
fromNum' 32 = Card 0 Sapphire (GemBag 1 0 1 2 1 0) 32
...
fromNum' 20 = Card 0 Sapphire (GemBag 1 0 1 1 1 0) 20
fromNum' 36 = Card 0 Sapphire (GemBag 0 0 0 0 3 0) 36
fromNum' 96 = Card 0 Sapphire (GemBag 1 0 2 2 0 0) 96
...
fromNum' 88 = Card 0 Sapphire (GemBag 0 0 2 0 2 0) 88
...
fromNum' 69 = Card 1 Sapphire (GemBag 0 0 0 4 0 0) 69
...
fromNum' 66 = Card 1 Sapphire (GemBag 0 2 3 0 3 0) 66
fromNum' 21 = Card 1 Emerald (GemBag 2 3 0 0 2 0) 21
fromNum' 26 = Card 2 Ruby    (GemBag 0 0 0 0 5 0) 26
fromNum' 41 = Card 1 Sapphire (GemBag 0 2 2 3 0 0) 41
...
fromNum' 95 = Card 2 Sapphire (GemBag 5 3 0 0 0 0) 95
fromNum' 60 = Card 3 Sapphire (GemBag 0 6 0 0 0 0) 60
...
fromNum' 75 = Card 2 Sapphire (GemBag 0 5 0 0 0 0) 75
fromNum' 43 = Card 1 Diamond (GemBag 2 3 0 3 0 0) 43
fromNum' 86 = Card 3 Emerald (GemBag 0 0 6 0 0 0) 86
fromNum' 76 = Card 2 Sapphire (GemBag 2 0 0 1 4 0) 76
...
fromNum' 35 = Card 3 Sapphire (GemBag 3 0 3 3 5 0) 35
...
fromNum' 94 = Card 4 Sapphire (GemBag 6 3 0 0 3 0) 94
...
fromNum' 59 = Card 4 Sapphire (GemBag 7 0 0 0 0 0) 59
fromNum' 25 = Card 5 Sapphire (GemBag 7 3 0 0 0 0) 25
